    ...
    <div className='w-full h-screen text-center'>
      <div className="max-w-[1240px] w-full h-full p-2 mx-auto flex justify-center items-center">
        ...
        Serving excellence since 2002...
         ...
         <div>
          <button className="mt-9 p-3 text-[black] font-semibold bg-gradient-to-r from-yellow-600 to-yellow-300 hover:scale-125 ease-in duration-300">book a demo session</button>
         </div>
            </div>
